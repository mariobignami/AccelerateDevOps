...
# Set parameters
export GKE_PROJECT=gcp-program
export GKE_CLUSTER=mb-cluster
export GKE_APP_NAME=mb-demo-shop
export GKE_SERVICE=mb-service
export GKE_SERVICE_ACCOUNT=mb-serviceaccount
export GKE_DEPLOYMENT_NAME=mb-demo-shop-deployment
